...
const Kids = () => {
  ...
  useEffect(() => {
    const kidsProducts = [
      { id: 13, name: "Cotton Printed Shorts", price: 739, discount: "75% off", img: `${process.env.PUBLIC_URL}/images/k1 (1).png`, rating: 4, brand: "Q-RIOUS" },
      { id: 14, name: "Boys Striped Cotton Pullover", price: 545, discount: "73% off", img: `${process.env.PUBLIC_URL}/images/k1 (2).png`, rating: 4, brand: "Leriya Fashion" },
      { id: 15, name: "Collar Cotton Casual Shirt", price: 299, discount: "85% off", img: `${process.env.PUBLIC_URL}/images/k1 (3).png`, rating: 3, brand: "ELEGANTE" },
      { id: 16, name: "Colourblocked A-Line Dress", price: 259, discount: "71% off", img: `${process.env.PUBLIC_URL}/images/k1 (4).png`, rating: 5, brand: "SNM MIFER" },
      { id: 17, name: "Flare Dress", price: 259, discount: "61% off", img: `${process.env.PUBLIC_URL}/images/k1 (5).png`, rating: 4.6, brand: "SNM MIFER" },
      { id: 18, name: "Girls Flared leggings", price: 280, discount: "41% off", img: `${process.env.PUBLIC_URL}/images/k1 (6).png`, rating: 4.2, brand: "ELEGANTE" },
    ];

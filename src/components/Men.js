...
const Men = () => {
  ...
  useEffect(() => {
    const menProducts = [
      { id: 7, name: "Formals", price: 899, discount: "60% off", img: `${process.env.PUBLIC_URL}/images/m1.jpg`, rating: 4, brand: "Levi's" },
      { id: 8, name: "Casuals", price: 1499, discount: "50% off", img: `${process.env.PUBLIC_URL}/images/m2.jpg`, rating: 4.5, brand: "Nike" },
      { id: 9, name: "T-shirt", price: 499, discount: "40% off", img: `${process.env.PUBLIC_URL}/images/m3.jpg`, rating: 4.2, brand: "Fastrack" },
      { id: 10, name: "Men's Joggers", price: 1000, discount: "55% off", img: `${process.env.PUBLIC_URL}/images/m4.jpg`, rating: 4, brand: "Adidas" },
      { id: 11, name: "Shirt", price: 1299, discount: "55% off", img: `${process.env.PUBLIC_URL}/images/m5.jpg`, rating: 4, brand: "Adidas" },
      { id: 12, name: "Sweatshirt", price: 1299, discount: "55% off", img: `${process.env.PUBLIC_URL}/images/m6.jpg`, rating: 4, brand: "Adidas" }
    ];
